                                ...
                                <table id="example" class="table table-bordered table-striped">
                                    ...
                                    <c:forEach items="${listClient}" var="client">
                                        <tr>
                                            ...
                                            <td>${client.addr}</td>
                                            <td>${client.koment}</td>
                                            <td><a href="<c:url value='/client/edit/${client.id}'/>">изменить</a></td>  <!--/client -->
                                            <td><a href="<c:url value='/client/remove/${client.id}'/>">удалить</a></td> <!--/client-->
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                    <tfoot>
